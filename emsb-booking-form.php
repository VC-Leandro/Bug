        ...
        <?php 
            ...
            if ($valid_customer_name && $valid_customer_email && $valid_customer_phone && $valid_service_id && $valid_service_name && $valid_booked_date_id && $valid_booked_slot_id && $valid_booked_date && $valid_booked_time_slot && $valid_emsb_booking_slot_starts_at ) {
                ...
                if($emsb_insert_booking){
                    ...
                    $customer_mail_body .= 'Nome do Paciente: ' . $customer_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Telefone de Contato: ' . $customer_phone_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Email de Contato: ' . $customer_email_address . '<br>' ."\r\n";
                    $customer_mail_body .= 'Médico Responsável: ' . $service_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Data da Consulta: ' . $booked_date_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Horário da Consulta: ' . $booked_time_slot_xss_proof_and_sanitized . '<br>' ."\r\n";
                    ...
                    $admin_email_Body .= ' <br>' ."\r\n";
                    $admin_email_Body .= ' <br>' ."\r\n";
                    $admin_email_Body .= 'Informações da Consulta:  <br>' ."\r\n";
                    $admin_email_Body .= 'Nome do Paciente: ' . $customer_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $admin_email_Body .= 'Telefone de Contato: ' . $customer_phone_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $admin_email_Body .= 'Email do Paciente: ' . $customer_email_address . '<br>' ."\r\n";
                    $admin_email_Body .= 'Médico Responsável: ' . $service_name_xss_proof_and_sanitized . '<br>' ."\r\n";
