<?php
/*
 * Plugin Name:	SEMUS Marcação de Consultas
 * Description: Plugin de Marcação de Consultas para as unidades da Secretaria de Saúde da Cidade de Queimados.
 * Author: 		Visão COOP
 * Version:		1.0.0
 * Author URI: 	https://www.facebook.com/visaocoop
 * License:     GNU GENERAL PUBLIC LICENSE Version 3,
 * License URI: https://www.gnu.org/licenses/gpl-3.0.txt
 * Text Domain: Visão COOP
*/
...
if ( !class_exists( 'emsb_service_booking_plugin_base_class' ) ) {
    class emsb_service_booking_plugin_base_class {
        ...
        // *************** post-type: Reviews **************//
            ...
            // *************** AM Time slot **************//
            $default_emsb_service_am_starting_time = "08:00";
            $default_emsb_service_am_ending_time = "11:59";
            $default_emsb_service_am_slot_duration = "20";
            ...
            // *************** PM Time slot **************//
            $default_emsb_service_pm_starting_time = "13:00";
            $default_emsb_service_pm_ending_time = "17:00";
            $default_emsb_service_pm_slot_duration = "20";
